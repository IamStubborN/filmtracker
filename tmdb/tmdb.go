...
type (
	...
	Film struct {
		...
		PosterLargePath string            `bson:"poster_large_path" json:"poster_large_path"`
		PosterSmallPath string            `bson:"poster_small_path" json:"poster_small_path"`
...
const posterLargeBaseURL = "http://image.tmdb.org/t/p/w500"
const posterSmallBaseURL = "http://image.tmdb.org/t/p/w200"
...
func (mdb *MovieDB) CreateMovieFromName(name string) (*Film, error) {
	...
	film := &Film{
		...
		PosterLargePath: posterLargeBaseURL + searchedFilm.PosterPath,
		PosterSmallPath: posterSmallBaseURL + searchedFilm.PosterPath,
